...
public class PptPage extends WhiteObject {
     ...
     * @param width   图片或动态 PPT 在白板中的宽度，单位为像素。
     * @param height  图片或动态 PPT 在白板中的高度，单位为像素。
     * @param preview 图片或动态 PPT 预览图的 URL 地址。动态 PPT 预览图的 URL 地址可以从查询转换任务的进度中的 `preview` 字段获取，例如，"https://docs-test-xxx.oss-cn-hangzhou.aliyuncs.com/dynamicConvert/2fdxxxxx67e/preview/1.png"。
     */
