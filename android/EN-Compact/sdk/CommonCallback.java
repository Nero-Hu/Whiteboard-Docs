...
public interface CommonCallback {
     ...
     * @since 2.13.22
     *
     * After you successfully call {@link WhiteSdkConfiguration#setLog(boolean) setLog}(true), the SDK triggers this callback to send you the local debug logs.
     *
     * If you need to disable this callback, call `setLog(false)`.
     *
     * @note
     * After you call `setLog(false)`, the SDK stops sending you the local debug logs through this callback, but still triggers this callback to send the logs related to [`video-js-plugin`](https://www.npmjs.com/package/@netless/video-js-plugin).
     *
     * @param object Log messages in JSON object format. Each log message contains the following keys:
