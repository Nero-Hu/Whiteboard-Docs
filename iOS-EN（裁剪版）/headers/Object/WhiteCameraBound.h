...
/**
 ...
 @param visionFrame The frame, that is, the value of (width * height) of the viewable area。

 @param minConfig The minimum frame (`visionFrame` * `miniScale`) of the viewable area.

 @param maxConfig The maximum frame (`visionFrame` * `maxScale`) of the viewable area.
