...
/**
 ...
 @note Ensure that you call `WhiteSdk` to initialize a `WhiteSdk` object before calling any other APIs.
...
/**
 This method is deprecated. Use initWithWhiteBoardView:config:commonCallbackDelegate: 和 initWithWhiteBoardView:config:commonCallbackDelegate:audioMixerBridgeDelegate: instead.
